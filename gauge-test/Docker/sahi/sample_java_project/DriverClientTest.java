...
//	protected String baseURL = "http://gramam";
	protected String baseURL = "http://sahitest.com";
...
//		browser.waitFor(condition, 5000);
	...
	public void xtestDragDrop(){
		browser.navigateTo(baseURL + "/demo/dragDropMooTools.htm");
		browser.div("Drag me").dragAndDropOn(browser.xy(browser.div("Item 2"), 5, 5));
//		browser.waitFor(3000);
		assertTrue(browser.div("dropped").exists());
		browser.waitFor(3000);		
